...
public class EnseignementNormal extends Enseignement {
	...
	public EnseignementNormal(String id, String shortName, String longName,float ects) {
		super(id, shortName, longName,ects);
	}
	
	public EnseignementNormal(String id, String shortName, String longName,float ects,float nbHC,float nbHTD, float nbHTP,CalculCoutEnseignement calculCoutEnseignement){
		this(id,shortName, longName,ects);
		this.ajoutActivite(new Activite( nbHC, nbHTD,  nbHTP, calculCoutEnseignement));
	}
